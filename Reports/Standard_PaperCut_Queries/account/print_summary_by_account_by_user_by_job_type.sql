...
SELECT     account4_.account_name                   AS col_0_0_, 
           ...
           user2_.full_name                         AS col_5_0_, 
           printerusa0_.paper_size                  AS col_6_0_, 
           printerusa0_.duplex                      AS col_7_0_, 
           Sum(printerusa0_.total_pages)            AS col_8_0_, 
           Sum(printerusa0_.usage_cost)             AS col_9_0_, 
           Count(printerusa0_.printer_usage_log_id) AS col_10_0_, 
           Sum(printerusa0_.total_color_pages)      AS col_11_0_ 
