...
select 
	...
	printerusa1_.paper_size as col_1_0_, 
	printerusa1_.duplex as col_2_0_, 
	sum(printerusa1_.total_pages) as col_3_0_, 
	sum(printerusa1_.usage_cost) as col_4_0_, 
	count(printerusa1_.printer_usage_log_id) as col_5_0_, 
	sum(printerusa1_.total_color_pages) as col_6_0_ 
from 
	tbl_user_field_history userfieldh0_, 
