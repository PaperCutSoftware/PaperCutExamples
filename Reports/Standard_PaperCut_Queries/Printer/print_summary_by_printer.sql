...
SELECT     printer1_.display_name                   AS col_0_0_, 
           ...
           Avg(printerusa0_.total_pages)    		AS col_2_0_, 
           Sum(printerusa0_.usage_cost)             AS col_3_0_, 
           Avg(printerusa0_.usage_cost)             AS col_4_0_, 
           Count(printerusa0_.printer_usage_log_id) AS col_5_0_, 
           printer1_.server_name                    AS col_6_0_, 
           printer1_.printer_name                   AS col_7_0_, 
           printer1_.physical_printer_id            AS col_8_0_, 
           printer1_.printer_type                   AS col_9_0_, 
           printer1_.location                       AS col_10_0_, 
           Sum(printerusa0_.total_sheets)           AS col_11_0_, 
